...
public class CraftingLoader {
    ...
    private static void registerMachineRecipe() {
        GTModHandler.addCraftingRecipe(
            UpgraderMain,
            bitsd,
            new Object[] { "CCC", "CMC", "CCC", 'M', BlockList.Machine_Casing_ULV, 'C',
                OrePrefixes.circuit.get(Materials.ULV) });
    }

    private static void registerUpgradeSmithingTemplateRecipe() {
        ItemStack[] Central_Synthetic_Item = { BlockList.Machine_Casing_LV, BlockList.Machine_Casing_MV,
            BlockList.Machine_Casing_HV, BlockList.Machine_Casing_EV, BlockList.Machine_Casing_IV,
            BlockList.Machine_Casing_Luv, BlockList.Machine_Casing_ZPM, BlockList.Machine_Casing_UV,
            BlockList.Machine_Casing_UHV, BlockList.Machine_Casing_UEV, BlockList.Machine_Casing_UIV,
            BlockList.Machine_Casing_UMV, BlockList.Machine_Casing_UXV, BlockList.Machine_Casing_ULV,
            BlockList.Machine_Hull_ULV, BlockList.Machine_Hull_LV, BlockList.Machine_Hull_MV, BlockList.Machine_Hull_HV,
            BlockList.Machine_Hull_EV, BlockList.Machine_Hull_IV, BlockList.Machine_Hull_LuV,
            BlockList.Machine_Hull_ZPM, BlockList.Machine_Hull_UV, BlockList.Machine_Hull_UHV,
            BlockList.Machine_Hull_UEV, BlockList.Machine_Hull_UIV, BlockList.Machine_Hull_UMV,
            BlockList.Machine_Hull_UXV, BlockList.Machine_Hull_MAX };

        for (int i = 0; i < Central_Synthetic_Item.length; i++) {
            GTModHandler.addCraftingRecipe(
                new ItemStack(upgradeSmithingTemplate, 1, i),
                bitsd,
                new Object[] { "ABC", "DEF", "GHI", 'A', ToolList.Single_Use_File, 'B', ToolList.Single_Use_Wrench, 'C',
                    ToolList.Single_Use_Crowbar, 'D', ToolList.Single_Use_Cutter, 'E', Central_Synthetic_Item[i], 'F',
                    ToolList.Single_Use_Hammer, 'G', ToolList.Single_Use_Mallet, 'H', ToolList.Single_Use_Screwdriver,
