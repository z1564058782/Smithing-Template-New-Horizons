...
@Mod(
    ...
    name = "Smithing Template New Horizons",
    acceptedMinecraftVersions = "[1.7.10]")
public class MyMod {

    public static final String MODID = "smithingtemplatenewhorizons";
    public static final Logger LOG = LogManager.getLogger(MODID);

    @SidedProxy(
        clientSide = "com.mofoga.smithingtemplatenewhorizons.ClientProxy",
        serverSide = "com.mofoga.smithingtemplatenewhorizons.CommonProxy")
